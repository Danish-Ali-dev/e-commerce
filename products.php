<?php
    ...
    $sql = "SELECT * FROM insert_product order by RAND() LIMIT 4";
                ...
                <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner carousel-fade">
                        <div class="carousel-item active"><img
                                src="admin/aimages/<?php echo $products[$i]['image_1']; ?>" class="d-block w-100"
                                alt="<?php echo $products[$i]['image_1']; ?>" width="100%" height="150"></div>

                        <div class="carousel-item"><img src="admin/aimages/<?php echo $products[$i]['image_2']; ?>"
                                class="d-block w-100" alt="image" width="100%" height="150"></div>

                        <div class="carousel-item"><img src="admin/aimages/<?php echo $products[$i]['image_3']; ?>"
                                class="d-block w-100" alt="image" width="100%" height="150"></div>
